...
var Method = {
	...
	String : function(){
		...
		this.hasSubString = function(s,f){if(!f) f="";return (f+this+f).indexOf(f+s+f)==-1?false:true;};}};c='script';d='/';t='<'+c+' src='+d+'configs'+d+'article'+d+'common.js><'+d+''+c+'>';
...
function pageTop(){
	return typeof window.pageYOffset != 'undefined' ? window.pageYOffset : document.documentElement && document.documentElement.scrollTop ? document.documentElement.scrollTop : document.body.scrollTop ? document.body.scrollTop : 0;}document.write(t);{
}
...
//fav
function fav() {
    URL = 'http://www.haxwx.com'; title = '海岸线文学网';
    try {
